...
export class Especialidades implements OnInit {
  ...
  ngOnInit(): void {
    this.cols = [
      ...
      { field: 'valorConsulta', header: 'Valor da Consulta', editable: true, type: 'currency', insertable: true },
      { field: 'limiteDiario', header: 'Limite Diario', editable: true, type: 'number', insertable: true },
    ];
  }
